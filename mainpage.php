...
<body>
    ...
    <section class="landing-section" id="p2" style="display:none;">
        <div class="landing-wrapper d-flex flex-column text-center align-items-center justify-content-center">
            ...
            <div>
                <button id="btn" class="vplay"> <i class="fa fa-play-circle fa-4x"></i> </button>
            </div>
        </div>
    </section>
    ...
    <section class="bg-dark text-teal text-center p-4">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3>Copyright &copy; 2022 , <a href="mainpage.html" class="navbar-brand font-weight-bold">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <p> webcounter <br><!-- hitwebcounter Code START -->
<a href="https://www.hitwebcounter.com" target="_blank">
<img src="https://hitwebcounter.com/counter/counter.php?page=8038806&style=0037&nbdigits=5&type=page&initCount=0" title="Free Counter" Alt="web counter"   border="0" /></a> </p>
                </div>
